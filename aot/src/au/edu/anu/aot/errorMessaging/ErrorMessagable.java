...
/**
 * <p>
 * An interface to manage error messages in a user-friendly way.
 * </p>
 * 
 * <p>
 * Purpose: these messages inform the user as to what steps to take to get a
 * possibly complex specification valid.
 * </p>
 * 
 * <ol>
 * <li>for any error there is the error description and action to undertake to
 * fix it, hence two messages;</li>
 * <li>the error context can be described by increasing the level of message
 * verbosity.</li>
 * </ol>
 * 
 * <ul>
...
public interface ErrorMessagable {
	...
	/**
	 * Largely for debugging. Some information that indicates exactly the type of
	 * message. For example implementations may use enums and so the type could be
	 * the enum.name(). Additional prefix to verbose2 strings.
	 * 
